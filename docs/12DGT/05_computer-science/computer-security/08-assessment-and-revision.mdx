---
title: "Session 8 — Assessment and revision"
sidebar_label: "8. Assessment and revision"
description: "Closed notes. Forty minutes. The timed assessment, its marking guide, and the Week 2 homework that turns lost marks into revision priorities."
hide_title: true
---
...
<Kicker>Computer Science · Security Unit · Session 8 of 8</Kicker>

<Headline>Closed notes. Forty minutes. Prove you understand it, not just remember it.</Headline>

<Dek>Seven sessions of controls, trade-offs and justification now get tested under time pressure, closed-book, against six questions that reward explanation over naming. Mark your own answers honestly against the guide below, then use what you got wrong to set next week's revision priorities — the whole point of this session is the feedback loop, not the score.</Dek>

<Byline>
  <span><strong>Session time:</strong> 60 minutes</span>
  <span aria-hidden="true">·</span>
  <span><strong>Homework:</strong> 120 minutes, Week 2</span>
  <span aria-hidden="true">·</span>
  <span>Closes the loop on Sessions 1–7</span>
</Byline>

<Hero
  src="/img/12DGT/computer-security/hero-08-assessment-and-revision.jpg"
  alt="A hand marking a multiple-choice answer sheet with a pen."
  caption="Marking your own paper only works if you do it after the 40 minutes are up, not before. Photo: Nguyen Dang Hoang Nhu / Unsplash"
/>
...
Begin the timed questions with your notes and the marking guide closed. **Do not watch videos before or during the assessment** — save the optional links below for the homework revision time, where they actually belong.
...
<StopBanner label="Stop here until your 40 minutes are finished">

Do not read past this point until the timed section above is actually done. The marking guide is below — reading it early defeats the entire purpose of a closed-notes assessment.
...
*Reading the diagram: match the depth to the command. A definition question does not require an essay; an evaluation question needs more than a definition.*

## Watch

<Callout kind="watch">

Choose a video only after identifying the concept you need to revise. These links are optional, and fit inside the homework revision block by replacing some flashcard time — not by adding to it.
...
These bands guide study; they do not predict an official exam grade. Pick two priorities from your actual mistakes, not just the total.

## Week 2 homework — 120 minutes total

<Callout kind="homework">

Four parts, roughly two hours total, spread across the second week. Part A turns today's marked paper directly into revision material — do it while the assessment is still fresh.
...
<CheckWork label="Reveal the self-check for Part B">
...
[**Previous session** · Design a security plan](07-design-a-security-plan.mdx)
