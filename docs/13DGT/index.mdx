...
```mermaid
flowchart LR
    A["Term 1: Web Design<br/>AS91901"] --> B["Term 2: Programming Project<br/>AS91906"]
    B --> C["Term 3–4: Full-Stack Website<br/>AS91903"]
    A -.->|UX/UI foundations| B
    B -.->|Code quality & testing| C
```
...
See [AI_Use_Guidance_Y13_Digital_Technologies.mdx](../student-resources/AI_Use_Guidance_Y13_Digital_Technologies.mdx) for detailed guidance.
...
- [Unit 1: Web Design & UX Principles](01_web-design/index.mdx) – Designing user-centred websites
- [Unit 2: Programming Project](02_programming/index.mdx) – Algorithm design, implementation, testing
- [Unit 3: Full-Stack Website Development](03_full-stack/index.mdx) – Frontend, backend, APIs, integration
