---
title: "Unit 1: Web Design & UX Principles"
...
You will learn to:
- understand user needs and research methods
- design websites that are accessible and usable for everyone
...
![Web Design infographic](/img/web-design-infographic.jpg)

---

## Topics in This Unit

- [1. User Research & Personas](01_user-research-and-personas.mdx) — Understanding who you're designing for
- [2. UX Task Terminology](02_ux-task-terminology.mdx) — Use cases, flows, and journeys: the shared vocabulary for how users move through your product
- [3. Information Architecture & Wireframing](03_information-architecture-wireframing.mdx) — Structuring information and sketching layouts
- [4. Visual Design Principles](04_visual-design-principles.mdx) — Colour, typography, layout, and visual hierarchy
- [5. Accessibility & WCAG Compliance](05_accessibility-wcag.mdx) — Designing for everyone, including people with disabilities
- [6. Prototyping & Tools](06_prototyping-tools.mdx) — Creating digital mockups and interactive prototypes
- [7. User Testing & Usability Evaluation](07_user-testing-usability.mdx) — Testing your designs with real users
- [8. Design Iteration & Feedback](08_design-iteration-feedback.mdx) — Improving your design based on evidence
...
- Topics 1–3 prepare you for wireframes and structure
- Topics 4, 6 prepare you for high-fidelity prototypes
- Topic 5 prepares you for accessibility requirements
- Topics 7–8 prepare you for user testing and iteration evidence

![Topic-to-assessment requirement mapping](/img/WD-1.0-03-assessment-topic-map.svg)
...
![The UX design process cycle](/img/WD-1.0-01-ux-process-cycle.svg)
...
![Overview of the six UX methodologies](/img/WD-1.0-02-six-ux-methodologies.svg)
...
- User testing notes and feedback summaries
- Design rationale explanations
- Progress in your iteration journal
...
Before final submission, you will participate in a **design critique session** where you:
- present your prototype to your teacher
- explain key design decisions and their rationale
- demonstrate how user testing informed your iterations
- justify accessibility compliance choices

Your teacher will ask questions like:
- *Why did you choose this colour scheme?*
- *How did this user's feedback change your layout?*
- *What accessibility principle does this feature address?*
...
![Four-week unit timeline](/img/WD-1.0-04-four-week-timeline.svg)

---

## Tools You'll Use

Recommended tools for wireframing and prototyping:
- **Figma** (free tier available; cloud-based; collaborative)
- **Adobe XD** (student access via school)
- **InVision** (prototyping and collaboration)
- **Pencil Project** (open-source; desktop-based)
- **Hand-drawn wireframes with digital annotation** (acceptable and often faster)
...
![Six common pitfalls to avoid](/img/WD-1.0-05-common-pitfalls.svg)
...
- **[Nielsen Norman Group – UX Articles](https://www.nngroup.com/articles/)** – Authoritative UX research and best practices
- **[Design Thinking: The Beginner's Guide](https://www.youtube.com/watch?v=_r0VX-aU_T8)** – Video overview of design thinking process

### Wireframing & Prototyping
- **[Figma Learning Resources](https://www.figma.com/resources/)** – Official Figma tutorials and guides
- **[The Wireframing Handbook (Maze.co)](https://maze.co/guides/wireframing/)** – Practical wireframing guide

### Accessibility
- **[WebAIM – Web Accessibility In Mind](https://webaim.org/)** – Clear accessibility guidance and tools
- **[WCAG 2.1 Quick Reference](https://www.w3.org/WAI/WCAG21/quickref/)** – Official WCAG checklist
- **[Accessibility for Everyone (A11ycasts by Google)](https://www.youtube.com/playlist?list=PLNYkxOF6rcICWx0C9Xc-RgEzwLvePng7V)** – YouTube series on practical accessibility

### Design Principles
- **[Laws of UX by Jon Yablonski](https://lawsofux.com/)** – Interactive guide to core design principles
- **[Gestalt Principles in UX Design](https://www.youtube.com/watch?v=FaS-wJiVi70)** – Video explaining visual grouping and hierarchy

### User Testing
- **[How to Conduct Usability Testing](https://www.nngroup.com/articles/usability-testing-101/)** – Nielsen Norman guide to planning and running tests
- **[Steve Krug – Don't Make Me Think](https://www.youtube.com/results?search_query=steve+krug+usability)** – Accessible usability principles (book or video summaries)
...
Start with [01_user-research-and-personas.mdx](01_user-research-and-personas.mdx) and work through each topic in order. Each topic builds on previous concepts.
