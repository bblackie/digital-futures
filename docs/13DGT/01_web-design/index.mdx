...
![Web Design infographic](/img/13DGT/web-design-infographic.jpg)
...
- [2. Information Architecture & Wireframing](02_information-architecture-wireframing.mdx) — Structuring information and sketching layouts
- [3. Visual Design Principles](03_visual-design-principles.mdx) — Colour, typography, layout, and visual hierarchy
- [4. Accessibility & WCAG Compliance](04_accessibility-wcag.mdx) — Designing for everyone, including people with disabilities
- [5. Prototyping & Tools](05_prototyping-tools.mdx) — Creating digital mockups and interactive prototypes
- [6. User Testing & Usability Evaluation](06_user-testing-usability.mdx) — Testing your designs with real users
- [7. Design Iteration & Feedback](07_design-iteration-feedback.mdx) — Improving your design based on evidence
...
![Topic-to-assessment requirement mapping](/img/13DGT/WD-1.0-03-assessment-topic-map.svg)
...
![The UX design process cycle](/img/13DGT/WD-1.0-01-ux-process-cycle.svg)
...
![Overview of the six UX methodologies](/img/13DGT/WD-1.0-02-six-ux-methodologies.svg)
...
![Four-week unit timeline](/img/13DGT/WD-1.0-04-four-week-timeline.svg)
...
![Six common pitfalls to avoid](/img/13DGT/WD-1.0-05-common-pitfalls.svg)
