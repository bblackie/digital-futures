...
You now understand accessibility principles. In the next topic, [Prototyping & Tools](06_prototyping-tools.mdx), you'll learn how to create functional, testable prototypes in Figma or similar tools.

---

*End of Topic 5: Accessibility & WCAG Compliance*
