...
![Visual hierarchy: four tools — size, colour, contrast, position](/img/WD-1.3-01-visual-hierarchy.svg)
...
![Three types of contrast — colour, type, and spatial](/img/WD-1.3-02-contrast-types.svg)
...
![White space: crowded vs breathable layout](/img/WD-1.3-03-white-space.svg)
...
![Typography essentials — serif vs sans-serif, scale and spacing](/img/WD-1.3-04-typography.svg)
...
![Colour psychology and palette strategy guide](/img/WD-1.3-05-colour-psychology.svg)
...
![Gestalt principles: proximity, similarity, continuance, closure](/img/WD-1.3-06-gestalt-principles.svg)
...
![Four common visual design misconceptions](/img/WD-1.3-07-misconceptions.svg)
...
You now understand visual design principles. In the next topic, [Accessibility & WCAG Compliance](05_accessibility-wcag.mdx), you'll learn how to ensure your designs work for everyone, including people with disabilities.

---

*End of Topic 4: Visual Design Principles*
```
