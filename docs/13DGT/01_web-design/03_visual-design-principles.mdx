...
![Visual hierarchy: four tools — size, colour, contrast, position](/img/13DGT/WD-1.3-01-visual-hierarchy.svg)
...
![Three types of contrast — colour, type, and spatial](/img/13DGT/WD-1.3-02-contrast-types.svg)
...
![White space: crowded vs breathable layout](/img/13DGT/WD-1.3-03-white-space.svg)
...
![Typography essentials — serif vs sans-serif, scale and spacing](/img/13DGT/WD-1.3-04-typography.svg)
...
![Colour psychology and palette strategy guide](/img/13DGT/WD-1.3-05-colour-psychology.svg)
...
![Gestalt principles: proximity, similarity, continuance, closure](/img/13DGT/WD-1.3-06-gestalt-principles.svg)
...
![Four common visual design misconceptions](/img/13DGT/WD-1.3-07-misconceptions.svg)
...
You now understand visual design principles. In the next topic, [Accessibility & WCAG Compliance](04_accessibility-wcag.mdx), you'll learn how to ensure your designs work for everyone, including people with disabilities.
