...
You now understand how to structure content and sketch layouts. In the next topic, [Visual Design Principles](04_visual-design-principles.mdx), you'll learn how to apply colour, typography, and visual hierarchy to create high-fidelity prototypes.

---

*End of Topic 3: Information Architecture & Wireframing*
