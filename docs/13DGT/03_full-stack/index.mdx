...
- [1. Web Application Architecture](01_web-app-architecture.mdx) – Understanding frontend/backend separation
- [2. Frontend Fundamentals](02_frontend-fundamentals.mdx) – HTML, CSS, responsive design, DOM manipulation
- [3. Backend Development](03_backend-development.mdx) – Server logic, APIs, request handling
- [4. RESTful API Design](04_restful-api-design.mdx) – Designing clean, predictable APIs
- [5. Database Design](05_database-design.mdx) – Relational schemas, queries, optimization
- [6. Frontend/Backend Integration](06_integration.mdx) – Connecting frontend to APIs, handling errors
- [7. Testing & Deployment](07_testing-deployment.mdx) – Testing full-stack, deploying applications
...
Start with [01_web-app-architecture.mdx](01_web-app-architecture.mdx) and work through each topic in order.
