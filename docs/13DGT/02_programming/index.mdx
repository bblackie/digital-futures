...
- [1. Algorithm Design & Complexity](01_algorithm-design-complexity.mdx) – Designing efficient solutions
- [2. Code Quality & Maintainability](02_code-quality-maintainability.mdx) – Writing readable, well-documented code
- [3. Testing & Debugging](03_testing-debugging.mdx) – Writing tests and systematically finding/fixing bugs
- [4. Data Structures](04_data-structures.mdx) – Choosing the right structure for the problem
- [5. Development Process](05_development-process.mdx) – Managing a multi-week project
- [6. Version Control & Git](06_version-control-git.mdx) – Tracking code changes and development history
...
Start with [01_algorithm-design-complexity.mdx](01_algorithm-design-complexity.mdx) and work through each topic in order.
