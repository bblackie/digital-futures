...
![Purpose of These Notes — what they do, what they are not, and connection to AS92004](/img/11DGT/PG-01-purpose.png)
...
![Key Concepts overview — six core ideas connecting Pygame to Python fundamentals](/img/11DGT/PG-02-key-concepts.png)
...
![What Pygame provides versus what you still write](/img/11DGT/PG-03a-what-is-pygame.png)
...
![The Game Loop — three phases mapped to IPO](/img/11DGT/PG-03b-game-loop.png)
...
![Events — how games receive and handle input using selection](/img/11DGT/PG-03c-events.png)
...
![Surfaces and Drawing — Clear, Draw, Flip workflow](/img/11DGT/PG-03d-surfaces-drawing.png)
...
![Pygame coordinate system — (0,0) at top-left, y increases downward](/img/11DGT/PG-03e-coordinates.png)
...
![Controlling Speed — with and without a clock](/img/11DGT/PG-03f-clock-speed.png)
...
![Worked Example: Moving Square — variables, each frame, and the clear-step bug](/img/11DGT/PG-05a-worked-example-movement.png)
